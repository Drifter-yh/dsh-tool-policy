...
// The fixture starts after the included tree activates. Await its completion so
// this executable remains deterministic for both the demo and the integration test.
